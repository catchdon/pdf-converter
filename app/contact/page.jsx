export const metadata = {
  ...
  alternates: {
    canonical: "https://www.networkkings.website/contact",
  },  
  openGraph: {
    title: "문의하기 | 문서킹",
    description: "문서킹 서비스 이용 중 궁금한 점이 있다면 언제든 연락해 주세요. 빠르고 친절하게 답변드리겠습니다.",
    url: "https://www.networkkings.website/contact",
    images: [
  ...
  return (
    <div className="max-w-2xl mx-auto py-12 px-4">
      ...
      <div className="bg-gray-100 rounded p-6 mb-6">
        ...
        <a href="mailto:contact@networkkings.website" className="text-blue-700 underline font-mono">
          contact@networkkings.website
        </a>
      </div>
      {/* 향후 폼 도입 시 아래 주석 해제 */}
