...
export async function generateMetadata({ params }) {
  const metadataMap = {
    "pdf-to-word": {
      ...
      openGraph: {
        title: "PDF를 워드로 변환 - 문서킹",
        description: "PDF 파일을 DOCX 워드 파일로 무료 변환! 온라인에서 쉽고 빠르게 변환하세요.",
        url: "https://www.networkkings.website/tool/pdf-to-word",
        images: [
    ...
    "pdf-to-image": {
      ...
      openGraph: {
        title: "PDF를 이미지로 변환 - 문서킹",
        description: "PDF 파일을 JPG/PNG 이미지로 변환! 한 번에 여러 페이지 변환 가능.",
        url: "https://www.networkkings.website/tool/pdf-to-image",
        images: [
    ...
    "pdf-to-excel": {
      ...
      openGraph: {
        title: "PDF를 엑셀로 변환 - 문서킹",
        description: "PDF 파일을 XLSX/CSV 엑셀 파일로 무료 변환! 표/리스트 추출에 최적화.",
        url: "https://www.networkkings.website/tool/pdf-to-excel",
        images: [
    ...
    "pdf-to-ppt": {
      ...
      openGraph: {
        title: "PDF를 파워포인트로 변환 - 문서킹",
        description: "PDF 파일을 PPTX 파워포인트 파일로 무료 변환! 프레젠테이션 제작을 빠르게.",
        url: "https://www.networkkings.website/tool/pdf-to-ppt",
        images: [
    ...
    "word-to-pdf": {
      ...
      openGraph: {
        title: "워드를 PDF로 변환 - 문서킹",
        description: "Word(.docx) 파일을 PDF로 무료 변환! 인쇄/공유에 최적화된 포맷 제공.",
        url: "https://www.networkkings.website/tool/word-to-pdf",
        images: [
    ...
    "image-to-pdf": {
      ...
      openGraph: {
        title: "이미지를 PDF로 변환 - 문서킹",
        description: "여러 장의 이미지를 하나의 PDF로 합치기! JPG, PNG 등 다양한 이미지 지원.",
        url: "https://www.networkkings.website/tool/image-to-pdf",
        images: [
    ...
    "excel-to-pdf": {
      ...
      openGraph: {
        title: "엑셀을 PDF로 변환 - 문서킹",
        description: "엑셀(xlsx, csv) 파일을 PDF로 무료 변환! 인쇄/제출용으로 손쉽게 변환.",
        url: "https://www.networkkings.website/tool/excel-to-pdf",
        images: [
    ...
    "ppt-to-pdf": {
      ...
      openGraph: {
        title: "파워포인트를 PDF로 변환 - 문서킹",
        description: "파워포인트(PPT, PPTX)를 PDF 문서로 무료 변환! 프레젠테이션 파일도 쉽게 인쇄.",
        url: "https://www.networkkings.website/tool/ppt-to-pdf",
        images: [
    ...
    "jpg-to-png": {
      ...
      openGraph: {
        title: "JPG를 PNG로 변환 - 문서킹",
        description: "JPG 이미지를 고화질 PNG로 무료 변환! 간편하게 이미지 포맷 변환 가능.",
        url: "https://www.networkkings.website/tool/jpg-to-png",
        images: [
    ...
    "png-to-jpg": {
      ...
      openGraph: {
        title: "PNG를 JPG로 변환 - 문서킹",
        description: "PNG 이미지를 고화질 JPG로 무료 변환! 사진, 스크린샷 포맷 변환도 손쉽게.",
        url: "https://www.networkkings.website/tool/png-to-jpg",
        images: [
    ...
    "heic-to-jpg": {
      ...
      openGraph: {
        title: "HEIC를 JPG로 변환 - 문서킹",
        description: "HEIC 이미지를 JPG로 변환! 아이폰 사진 호환성 문제를 한방에 해결.",
        url: "https://www.networkkings.website/tool/heic-to-jpg",
        images: [
    ...
    "jpg-to-webp": {
      ...
      openGraph: {
        title: "JPG를 WEBP로 변환 - 문서킹",
        description: "JPG 이미지를 웹 최적화 WEBP 포맷으로 무료 변환! 이미지 압축까지 한 번에.",
        url: "https://www.networkkings.website/tool/jpg-to-webp",
        images: [
    ...
    "png-to-webp": {
      ...
      openGraph: {
        title: "PNG를 WEBP로 변환 - 문서킹",
        description: "PNG 이미지를 WEBP 포맷으로 무료 변환! 이미지 품질은 유지, 용량은 줄이기.",
        url: "https://www.networkkings.website/tool/png-to-webp",
        images: [
  ...
  if (!meta) {
    return { title: "문서킹 - 무료 문서/이미지 변환 사이트", description: "PDF, 이미지, 오피스 파일을 쉽고 빠르게 변환하세요." };
  }
  return meta;
}
